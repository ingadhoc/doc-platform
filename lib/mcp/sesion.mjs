 ...
 */
export async function firmarSesion(datos, secreto, { ttlSegundos = TTL_POR_DEFECTO, ahora } = {}) {
  ...
  const cuerpo = aBase64Url(
    encoder.encode(JSON.stringify({ ...datos, exp: emitido + ttlSegundos })),
  );
 ...
 * formato roto, expirada, sin `exp`, o secreto ausente (fail-closed).
 *
 ...
 */
export async function verificarSesion(valor, secreto, { ahora } = {}) {
