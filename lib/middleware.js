 ...
 *    DOCS_MCP_TOKENS, y para DOCS_AUTH_PASSWORD en el camino humano.
 *
 ...
 *   DOCS_AUTH_USER     = usuario (opcional, default "adhoc")
 *   DOCS_AUTH_PASSWORD = la credencial compartida (humanos, Basic)
 ...
 * testeable: `npm run test:middleware`). NADA de `auth.mjs` en esta capa: usa
...
export default function middleware(request) {
  const respuesta = decidir(request, process.env, { audiencias: AUDIENCIAS });
